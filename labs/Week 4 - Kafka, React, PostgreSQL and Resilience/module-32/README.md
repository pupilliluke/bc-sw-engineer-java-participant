# Module 32 — Start here

> **Pacing:** [PACING.md](PACING.md) — Learn→Practice checkpoints **A–E**. Order **1 → 2 → 3 → 4 → 5 → 6**, then Lab 32.
...
**Pre-lab vs lab:** Pre-lab exercises are markdown notes under `examples/module-32-exercises/notes/`. Lab 32 is the graded project (see lab guide paths). Do not merge the two paths.
