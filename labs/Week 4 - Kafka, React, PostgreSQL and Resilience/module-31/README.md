...
| 1 | After slides → [`exercises/EXERCISES-INDEX.md`](exercises/EXERCISES-INDEX.md), exercises **in order** (see **What you produce** for exact `notes/lab31-*.md` files) |
...
**Pre-lab vs lab:** Pre-lab exercises are markdown notes under `examples/module-31-exercises/notes/`. Lab 31 is the graded project (see lab guide paths). Do not merge the two paths.
