...
# SQL performance lab — follow GUIDE psql steps under database/performance/
# psql "host= port=5432 dbname=crm user=crm_app" -f database/performance/02_baseline.sql
`

## Do the lab

Complete every step in **[LAB-38-GUIDE.md](LAB-38-GUIDE.md)**. GUIDE paths already use `~/java-bootcamp`.  
Open/run IntelliJ steps are the same every lab — see [IDE conventions](../../../Week%201%20-%20Java%20and%20JVM%20Foundations/_IDE-CONVENTIONS.md).

## Evidence / screenshots

Save under `~/java-bootcamp/notes/screenshots/lab-38`. Capture IntelliJ (project tree + Run/Terminal). Redact secrets.
...
| 5 | Screenshots (if required) under `notes/screenshots/lab-38/` | Pass / Fail |
