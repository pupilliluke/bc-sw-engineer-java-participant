...
6. **View → Tool Windows → Terminal** (PowerShell) → `cd $env:USERPROFILE\java-bootcamp` then `cd examples\lab35-crm\crm-ui` when ready.
...
3. **Terminal → New Terminal** (PowerShell) → `cd examples\lab35-crm\crm-ui` for this lab’s commands.
