...
| D | Graded lab (post-exercise consolidation) | [`lab4/LAB-4-GUIDE.md`](lab4/LAB-4-GUIDE.md) — in class use [`lab4/starter/`](lab4/starter/README.md) (~45 min); full path = every Step |
