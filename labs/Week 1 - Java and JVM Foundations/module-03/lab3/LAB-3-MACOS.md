...
Save under `~/java-bootcamp/notes/screenshots/lab-3`. Capture IntelliJ (project tree + Run/Terminal). Redact secrets.
...
| 5 | Screenshots (if required) under `notes/screenshots/lab-3/` | Pass / Fail |
