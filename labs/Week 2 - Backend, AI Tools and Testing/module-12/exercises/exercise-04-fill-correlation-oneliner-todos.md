# Exercise 4 — Fill Correlation One-Liner TODOs

**Module 12** · Hands-on exercise · [setup](EXERCISES-INDEX.md)

## Goal

Complete fill-in blanks for correlation one-liners used during refactor notes.

## Steps

### Step 1 — Copy TODOs

Create `notes/lab12-correlation-todos.md` and paste:
...
Filled correlation TODOs ready for Lab 12 notes.
...
| 3 | PII exclusion named | Pass / Fail |
