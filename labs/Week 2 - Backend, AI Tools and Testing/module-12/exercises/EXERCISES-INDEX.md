...
> Complete these exercises after the slides and before Lab 12.  
...
| --- | --- | --- | --- |
| 1 | Smell Bingo | Spot code smells | [`exercise-01-smell-bingo.md`](exercise-01-smell-bingo.md) |
| 2 | Equals vs == | Safe comparisons | [`exercise-02-equals-vs-eqeq.md`](exercise-02-equals-vs-eqeq.md) |
| 3 | Target API Sketch | Design before refactor | [`exercise-03-target-api-sketch.md`](exercise-03-target-api-sketch.md) |
| 4 | Fill Correlation One-Liner TODOs | Correlation hygiene | [`exercise-04-fill-correlation-oneliner-todos.md`](exercise-04-fill-correlation-oneliner-todos.md) |
| 5 | SOLID Apply vs Defer | Scope SOLID honestly | [`exercise-05-solid-apply-defer.md`](exercise-05-solid-apply-defer.md) |
| 6 | Lab 12 Prep Checklist | Pre-lab self-check | [`exercise-06-lab12-prep-checklist.md`](exercise-06-lab12-prep-checklist.md) |

Keep all work separate from `examples/lab12-crm` (or the lab’s named project folder); that project begins in the full lab.
