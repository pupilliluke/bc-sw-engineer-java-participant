# Exercise 4 — Fill Fault Envelope TODOs

**Module 13** · Hands-on exercise · [setup](EXERCISES-INDEX.md)

## Goal

Complete fill-in blanks for a NotFound fault when CUS-9999 is requested.

## Steps

### Step 1 — Copy envelope TODOs

Create `notes/lab13-fault-todos.md` and paste:
...
Filled fault TODOs with CUS-9999 and Lab 24 deferral.
...
| 2 | CUS-9999 and lab-request-001 present | Pass / Fail |
