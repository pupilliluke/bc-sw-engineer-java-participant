...
> Complete these exercises after the slides and before Lab 23.  
...
| --- | --- | --- | --- |
| 1 | Boot Starters Inventory | Name what each starter contributes | [`exercise-01-starters-inventory.md`](exercise-01-starters-inventory.md) |
| 2 | application.yml Sketch | Draft minimal Boot YAML keys | [`exercise-02-application-yml-sketch.md`](exercise-02-application-yml-sketch.md) |
| 3 | Auto-Config Versus Ownership | Distinguish Boot gifts from design work | [`exercise-03-autoconfig-vs-ownership.md`](exercise-03-autoconfig-vs-ownership.md) |
| 4 | CrmApplication Stub (TODOs) | Complete a minimal Boot entry-point sketch | [`exercise-04-crm-application-stub.md`](exercise-04-crm-application-stub.md) |
...
Keep all work separate from `examples/lab23-crm` (or the lab’s named project folder); that project begins in the full lab.
