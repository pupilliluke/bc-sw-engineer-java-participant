# Exercise 1 — Boot Starters Inventory

**Module 23** · Analysis exercise · [setup](EXERCISES-INDEX.md)

## Goal

Map Boot starters to Northstar CRM capabilities for Lab 23.
...
Starter meanings and ownership boundary are clear.

## Pass criteria

| # | Confirm | Notes |
| --- | --- | --- |
| 1 | Three starters explained | Pass / Fail |
| 2 | Three ownership items listed | Pass / Fail |
| 3 | Pre-lab boundary stated | Pass / Fail |
