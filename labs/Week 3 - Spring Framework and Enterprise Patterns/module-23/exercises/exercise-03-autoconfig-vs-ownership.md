# Exercise 3 — Auto-Config Versus Ownership

**Module 23** · Documentation exercise · [setup](EXERCISES-INDEX.md)

## Goal

Produce a three-and-three list Lab 23 expects in notes.
...
Balanced gift/ownership note ready for Lab 23 evidence.

## Pass criteria

| # | Confirm | Notes |
| --- | --- | --- |
| 1 | Three gifts listed | Pass / Fail |
| 2 | Three ownership items listed | Pass / Fail |
