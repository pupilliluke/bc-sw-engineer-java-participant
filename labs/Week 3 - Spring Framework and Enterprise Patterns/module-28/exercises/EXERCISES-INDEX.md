...
> Complete these exercises after the slides and before Lab 28.  
...
| 3 | MockMvc Evidence Matrix | Plan 401/403/200 automated proofs | [`exercise-03-mockmvc-matrix.md`](exercise-03-mockmvc-matrix.md) |
| 4 | JWT Login TODOs | Fill login/filter pseudocode blanks | [`exercise-04-jwt-login-todos.md`](exercise-04-jwt-login-todos.md) |
...
Keep all work separate from `examples/lab28-crm` (or the lab’s named project folder); that project begins in the full lab.
