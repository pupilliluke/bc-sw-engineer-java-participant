...
public class ReportService {
    ...
    public void displayBonusInsights() {
        ...
        employeeService.findSecondHighestSalary().ifPresentOrElse(
                ...
                () -> System.out.println("Second Highest Salary : N/A"));

        employeeService.findEmployeeWithLongestName().ifPresent(e ->
                System.out.println("Longest Name : " + e.getName()
                        + " (" + e.getName().length() + " chars)"));
        ...
        employeeService.generateSalaryHistogram().forEach((bucket, count) ->
                System.out.printf("  %-8s : %d%n", bucket, count));
